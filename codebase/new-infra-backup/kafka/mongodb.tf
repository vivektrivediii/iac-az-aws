# data "mongodbatlas_teams" "admin" {
#   org_id = var.mongodbatlas_org_id
#   name   = var.mongodbatlas_adminteam
# }

# data "mongodbatlas_teams" "developers" {
...
#   teams {
#     team_id    = data.mongodbatlas_teams.admin.team_id
...
#   lifecycle {
#     ignore_changes = [provider_instance_size_name, provider_region_name]
#   }
